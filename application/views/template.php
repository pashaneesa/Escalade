		...
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#">
					<img src="<?php echo base_url()?>assets/images/logo.jpg" width="60%">
				</a>
			</div>
			<div class="collapse navbar-collapse" id="mynavbar-content">
				<ul class="user-menu sidebar-collapse"> 
					<li class="pull-right" ><button class="navigasi-btn btn menu1" onclick="location.href='<?php echo base_url('Auth/logout')?>';" style="margin-right: 10px">	Profile saya</button></li>
