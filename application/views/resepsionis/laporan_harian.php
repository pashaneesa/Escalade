            ...
            <div class="row">
                <div class="col-md-9">
                    <div class="col-md-12">
                        ...
                        <a href="<?php echo base_url('Superdokter/export_per_dokter') ?>" class="btn" style="margin-top: 45px; margin-left: 5px; background-color: #e7e6e6; border: none; color:#f40049; font-weight:bold; float: right;">
