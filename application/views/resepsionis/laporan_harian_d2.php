            ...
            <div class="row">
                <div class="col-md-9">
                    <div class="col-md-12" style="margin-left: 20px;">
                        ...
                        <a href="<?php echo base_url('Superdokter/export_per_dokter') ?>" class="btn" style="background-color: #e7e6e6; border: none; color:#f40049; font-weight:bold; float: right; ">
                            <img src="<?php echo base_url() ?>assets/images/download.png" height="30px">
                            Download<br><span style="font-size: 11px;">per-dokter</span>
                        </a>
                        <a href="<?php echo base_url('Superdokter/export_harian') ?>" class="btn" style="background-color: #e7e6e6; border: none; color:#f40049; font-weight:bold; float: right; margin-right: 20px;">
                            <img src="<?php echo base_url() ?>assets/images/download.png" height="30px">
                    ...
                    <div class="col-md-12" style="border: 1px solid #e0e0e0; margin-top: 5px;">
                        <div style="float: left">
                            ...
                            <a href="<?php echo base_url('Superdokter/laporan_harian') ?>">
                ...
                <div class="col-md-3" style="background-color:  #f2f2f2; padding:0px;height: 915px;">
