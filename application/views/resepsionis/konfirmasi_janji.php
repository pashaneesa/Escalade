			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-body">
						<font style="font-weight: bold; font-size: 20px;">Konfirmasi Janji</font><br><br>
								...
								<?php foreach ($booking->result() as $result): ?>
									...
									<tr>
										...
										<div id="myModal<?php echo $result->id_pasien?>" class="modal" style="top: 100px;">
											<form class="form-horizontal" action="<?php echo base_url('Superdokter/konfirmasi/');?>" method="post" enctype="multipart/form-data" role="form">
										...
										<div id="ModalTolak<?php echo $result->id_pasien?>" class="modal" style="top: 50px;">
											<form class="form-horizontal" action="<?php echo base_url('Superdokter/Konfirmasi_tolak/');?>" method="post" enctype="multipart/form-data" role="form">
												<div class="modal-dialog">
													<div class="modal-content">
														<div class="modal-header">
															<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
														...
														<div class="col-lg-12">
															...
															<div class="modal-body">
																<h5 class="madal-body"> <center>Pasien atas nama <?php echo $result->nama_depan ?> <?php echo $result->nama_belakang ?> telah ditolak.</center></h5>

																<h5><center>Mohon agar dapat memberikan alasan penolakan,</center></h5>
																<h5><center>serta opsi jadwal atau dokter untuk pasien.</center></h5>
																...
																<br>
																<h5><center>Apakah Anda yakin akan menolak janji pasien?</center></h5>
																<br>
																<h5><center>Dengan menekan tombol dibawah, maka konfirmasi penolakan akan secara otomatis terkirim beserta pesan dari klinik.</center></h5>
														...
														<div class="modal-footer">
															<center><button class="btn salmon remove" type="submit"> Ya, Kirim Konfirmasi Penolakan</button></center>
															<!-- <button type="button" class="btn btn-warning" data-dismiss="modal"> Batal</button>  -->
														</div>
