...
@media only screen and (min-width: 900px) {
	...
	.box-rencana{
		box-shadow: box-shadow: 2px 2px #888888;
		border: 1px solid #e0e0e0;
		padding-left: 20px;
		margin-bottom: 20px;
	}
						...
						<div class="tab-content col-md-8">
							<?php foreach ($bayar->result() as $result) : ?>
								<div id="metode_pembayaran"  class="tab-pane fade in active">
									<form action="<?php echo base_url('Superdokter/update_bayar/');?>" method="post" enctype="multipart/form-data" id="form1">
										...
										<div class="col-md-12">
											...
											<div id="asuransiku" hidden>
												<div class="col-md-12">
													...
													<button data-toggle="tab" href="#proses_bayar"  type="button" class="btn salmon stil1" style="float: right;margin-top: 18%;">Selanjutnya</button>
												</div>
												...
												<div id="proses_bayar" class="tab-pane fade" style="margin-left: -20px">
													<div class="col-md-12">
														...
														<div class="col-lg-12">
															<table width="700px">
																<?php foreach ($layanan->result() as $hasil) : ?>
																	<?php $jml = 0;
																	$jml = $hasil->harga * $hasil->jumlah;

																	?>
																	<tr>
																		<td width="300px"><?php echo $hasil->layanan; ?></td>
																		<td width="100px">X <?php echo $hasil->jumlah; ?></td>
																		<td width="150px">Rp.<?php echo $hasil->harga; ?></td>
																		<td width="150px">Rp.<?php echo $jml; ?></td>
																	</tr>
																<?php endforeach; ?>
															</table>

															<hr width="620" class="pull-left">
															<br>
														</div>
														<div class="col-lg-12">
															<p style="float: left;"><b>Sub Total</b></p>
															<input type="text" class="form-control numeric" placeholder="0" value="<?php echo $result->subtotal?>" name="subtotal" id="subtotal" style="text-align:right; margin-left: 540px; width: 80px; border: 0px;" disabled>
														</div>

														<div class="col-lg-3">
															<select class="form-control" name="cmb" id="cmb" onchange="addText();">
																<option disabled selected style="display: none;">Pilih Diskon</option>
																<?php foreach($diskon as $hasil):?>
																	<option  value="<?php echo $hasil['nilai_diskon'];?>" ><?php echo $hasil['nama_diskon'];?></option>
																<?php endforeach;?>
															</select>
														</div>
														<div class="col-lg-6">
															<?php echo form_error("Biaya_layanan");?>
															<input class="form-control numeric" placeholder="0" value="0" name="txt" id="txt" style="text-align:right; width: 385px;border: 0px;" disabled type="text">
															<br>										
														</div>
														<div class="col-lg-12">
															<p style="float: left;"><b>Grand Total</b></p>
															<input type="text" class="form-control" placeholder="<?php echo $result->subtotal?>" name="hasil" id="hasil" style="text-align:right; margin-left: 523px; width: 100px; border: 0px;" readonly>
														</div>
														
														<div class="col-lg-12">	
															<button data-toggle="tab" href="#metode_pembayaran"  type="button" class="btn salmon stil2" style="float: left;margin-top: 3%;">Kembali</button>
															<button type="submit" class="btn salmon stil3" style="float: right;margin-top: 3%;">Proses</button>
														</div>
