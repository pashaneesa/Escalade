...
<link href="<?php echo base_url() ?>assets/style.css" rel="stylesheet">
	...
	<nav class="sidebar2">
	<ul >
		<li><a href="#"><i class="lnr lnr-home"> Home</i></a></li>
			<hr>
			<li><a href="#"><i class="lnr lnr-calendar-full"> Konfirmasi Janji</i></a></li>
			<hr color="white">
			<li><a href="#"><i class="lnr lnr-checkmark-circle"> Registrasi / Ubah Janji</i></a></li>
			<hr color="white">
			<li><a href="#"><i class="lnr lnr-printer"> Pembayaran</i></a></li>
			<hr color="white">
			<li><a href="#"><i class="lnr lnr-file-add"> Laporan Harian</i></a></li>
			<hr color="white">
		...
		<li role="presentation" class="divider"></li><hr color="white">
		...
		<li role="presentation" class="divider"></li><hr color="white">
		<li <?php if (isset($_update_user)) 	  echo 'class="active"';?>><a href="<?php echo site_url('user')?>"><svg class="glyph stroked male-user"><use xlink:href="#stroked-male-user"></use></svg> Update User</a></li><hr color="white"> -->
    </ul>
</nav>
<!--/.sidebar-->