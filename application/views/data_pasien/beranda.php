            ...
            <nav class="navbar navbar-default">
               ...
               <form action="<?php echo base_url('Pasien/add_booking');?>" method="post">
                <ul class="nav navbar-nav">
                  <li class="dropdown mega-dropdown"> <a href="#" class="" data-toggle=""><b>Pilih Profil</b><br><br><font color="#90a4ae">
                    <div id="id_pasien2">Pilih Profil Pasien<br><br><br></div></font><span class="glyphicon glyphicon-chevron-down pull-right"></span></a>  
                    <ul class="dropdown-menu mega-dropdown-menu row">
                      <?php foreach ($pasien->result() as $result1) : ?>
                        <li class="col-sm-6" style="list-style-type: none;">
                          ...
                          <button class="btn salmon col-sm-6" style="float: right; width: 100px" type="button" onclick="pilih_pasien('<?php echo $result1->id_pasien ?>')">Pilih</button>
                      ...
                      <li class="col-sm-6" style="list-style-type: none;">
                        ...
                        <button class="btn salmon col-sm-6" style="float: right; width: 100px" type="button" onclick="location.href ='<?php echo base_url('Pasien/tambah_pasien');?>'">Pilih</button>
                  ...
                  <li class="dropdown mega-dropdown"> <a href="#" class="dropdown-toggle" data-toggle=""><b>Pilih Cabang</b><br><br><font color="#90a4ae">
                    ...
                    <ul class="dropdown-menu mega-dropdown-menu row">
                      <div class="megamenu-headline">
                        <center><h3>Jakarta Selatan</h3></center>
                      </div>
                      <hr>  
                      <?php foreach ($cabang->result() as $result2) : ?>
                        <li class="col-sm-6" style="list-style-type: none; height: 70px; ">
                          <div class="col-sm-6">          
                            <b><?php echo $result2->nama_cabang  ?><br></b>
                            <?php echo $result2->alamat ?><br>
                          </div>
                          <button class="btn salmon col-sm-6" style="float: right; width: 100px" type="button" onclick="pilih_cabang('<?php echo $result2->id_cabang ?>')">Pilih</button>
                          <input type="hidden" name="id_cabang" value="<?php echo $result2->id_cabang ?>">
                        </li>
                      <?php endforeach; ?>
                    </ul>
                  </li>
                  <li class="dropdown mega-dropdown"> <a href="#" class="dropdown-toggle" data-toggle=""><b>Pilih Dokter</b><br><br><font color="#90a4ae">
                  ...
                  <ul class="dropdown-menu mega-dropdown-menu row">
                   ...
                   <?php foreach ($dokter->result() as $result3) : ?>
                    <li class="col-sm-6" style="list-style-type: none;">
                      ...
                      <button class="btn salmon col-sm-6" style="float: right; width: 100px" type="button" onclick="pilih_dokter('<?php echo $result3->id_dokter ?>')">Pilih</button>
                  ...
                  <!-- <li class="col-sm-6" style="list-style-type: none;">
                    <div class="col-sm-8">          
                      <b>Drg Pilihan Kami<br></b>
                      Dengan memilih opsi ini, maka klinik akan menentukan dokter yang paling sesuai dengan keluhan kamu<br>
                    </div>
                    <button class="btn salmon col-sm-4" style="float: right; width: 100px" ype="button" onclick="pilih_dokter('<?php echo $result3->id_dokter ?>')">Pilih</button>
                  ...
                  <li class="col-sm-6" style="list-style-type: none;">
                    ...
                    <button class="btn salmon col-sm-6" style="float: right; width: 100px" type="button" onclick="location.href ='<?php echo base_url('Pasien/jadwal_dokter');?>'">Pilih</button>
                    <div class="col-sm-12"> <hr> </div>
                  </li>
                </ul>
              </li>
              <li>
                <div class="form-group" style="padding-top: 25%; padding-left: 15%">
                  <center><button class="btn btn-anim" style="height: 75px; width: 200px; background-color: #e28a9d; color: white; border-radius: 15px" ><i class="fa fa-shopping-cart"></i><span class="btn-text">Cek Jadwal</span></button></center>
