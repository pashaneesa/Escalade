                ...
                <form action="<?php echo base_url('Superdokter/add_booking');?>" method="post">
                  <ul class="nav navbar-nav">
                    <li class="dropdown  mega-dropdown"> <a href="#" class="" data-toggle="" style="border-radius: 5px; padding: 7px; width: 200px; background-color: #f40049;; color: white">
                      <div id="id_user2"><font style="margin-left: 10px;"> Cari Akun Keluarga <span class="glyphicon glyphicon-search" style="color: white;margin-right: 10px;float: right;"></span></font></div></a> 
