...
.mega-dropdown { position: relative;/*width:100%;*/ }
        ...
        <div class="col-md-12">
            <nav class="navbar navbar-default">
              <div class="nav-collapse">
                ...
                <form action="<?php echo base_url ('Superdokter/add_booking');?>" method="post">
                  <ul class="nav navbar-nav">
                    <li class="dropdown  mega-dropdown"> <a href="#" class="" data-toggle="" style="border-radius: 5px; padding: 7px; width: 200px; background-color:  #f40049; color: white">
                      <div id="id_user2"><font style="margin-left: 10px;"> <?php foreach ($user->result() as $result3) : echo $result3->nama_depan_u; ?> <?php echo $result3->nama_belakang_u; endforeach; ?><span class="glyphicon glyphicon-search" style="color: white;margin-right: 10px;float: right;"></span></font></div></a>  
                      <ul class="dropdown-menu mega-dropdown-menu row" style="padding: 30px;">
                        <table id="all_data_json" data-toggle="table"
                        data-url="<?php echo base_url('Superdokter/data_keluarga');?>"
                  ...
                  <li>
                    <div class="form-group" style="">
                      <center><button class="btn btn-anim btn-white" style="width: 200px; border-radius: 5px" type="button"  onclick="location.href ='<?php echo base_url('Superdokter/tambah_pasien');?>'"><span class="btn-text">Buat Akun Keluarga</span></button></center>
      ...
      <div class="col-md-12">
        <nav class="navbar navbar-default">
          <div class="nav-collapse">
           ...
           <form action="<?php echo base_url('Superdokter/add_booking');?>" method="post">
            <ul class="nav navbar-nav">
              <li class="dropdown mega-dropdown"> <a href="#" class="" data-toggle=""><b>Pilih Profil</b><br><br><font color="#90a4ae">
                <div id="id_pasien2">Pilih Profil Calon Pasien<br><br><br><br></div></font><span class="glyphicon glyphicon-chevron-down pull-right"></span></a>  
                <ul class="dropdown-menu mega-dropdown-menu row">
                  ...
                  <li class="col-sm-6" style="list-style-type: none;">
                        ...
                        <button class="btn salmon col-sm-6" style="float: right; width: 100px" type="button" onclick="location.href ='<?php echo base_url() ?>Superdokter/tambah_pasien_k/<?php echo $result1->id_user ?>'">Pilih</button>
              ...
              <li class="dropdown mega-dropdown"> <a href="#" class="dropdown-toggle" data-toggle=""><b>Pilih Cabang</b><br><br><font color="#90a4ae">
                <div id="id_cabang2"> Ketik kota, daerah, atau cabang yang kamu tuju (Jakarta Selatan, Tebet Surabaya, dst)</div></font><span class="glyphicon glyphicon-chevron-down pull-right"></span></a>
                <ul class="dropdown-menu mega-dropdown-menu row">
              ...
              <li class="dropdown mega-dropdown"> <a href="#" class="dropdown-toggle" data-toggle=""><b>Pilih Dokter</b><br><br><br><font color="#90a4ae">
                <div id="id_dokter2">  Cari Spesialisasi (Umum, Konservasi Gigi, Gigi Anak) atau nama dokter (Alana)</div>
              </font> <span class="glyphicon glyphicon-chevron-down pull-right"></span></a>
              <ul class="dropdown-menu mega-dropdown-menu row">
              ...
              <li class="col-sm-6" style="list-style-type: none;">
                ...
                <button class="btn red col-sm-6" style="float: right; width: 100px" type="button" onclick="location.href ='<?php echo base_url('Pasien/jadwal_dokter');?>'">Pilih</button>
                <div class="col-sm-12"> <hr> </div>
              </li>
            </ul>
          </li>
          <li>
            <div class="form-group" style="padding-top: 25%; padding-left: 15%">
              ...
              value="<?php foreach ($user->result() as $result3) : echo $result3->id_user; endforeach; ?>">
              <input type="hidden" name="status" value="0">
            </div>
          </li>
        </ul>
...
<div class="row">
  <div class="col-lg-4">
    <div class="panel panel-default">
      <div class="panel-body">
        <div class="col-md-12">
          <center><font style="font-weight: bold; font-size: 17px;" >Jadwal yang akan datang</font><br><br></center>
        </div><!-- 
        <div class="col-md-6">
          <div class="form-group">
            <select id="filter_p" class="form-control">
  ...
  <div class="col-lg-4">
    <div class="panel panel-default">
      <div class="panel-body">
        <div class="col-md-12">
          <center><font style="font-weight: bold; font-size: 17px;" >Pemerikasaan Berjalan</font><br><br></center>
        </div>
        <!-- <div class="col-md-6">
          <div class="form-group">
            <select id="filter_p" class="form-control">
  ...
  <div class="col-lg-4">
    <div class="panel panel-default">
      <div class="panel-body">
        <div class="col-md-12">
          <center><font style="font-weight: bold; font-size: 17px;" >Jadwal pemeriksaan sebelumnya</font><br><br></center>
        </div>
        <!-- <div class="col-md-6">
          <div class="form-group">
...
<script type="text/javascript">
  ...
  function pilih_pasien(id){ 
    ...
    function pilih_user(id){ 
      $.get(linke+"Superdokter/ajax_get_user/"+id,$(this).serialize())
      .done(function(data){
        $('#id_user2').html(data);
      })
    }   
  ...
  <script>
    ...
    function profil(){
      var id = $('#filter_p').val();
      $.ajax({
        url : "<?= base_url('Superdokter/filter_profil') ?>",
        data : "id=" + id,
      ...
      $.ajax({
        url : "<?= base_url('Superdokter/filter_profil_2') ?>",
        data : "id=" + id,
        success:function(data){
      ...
      $.ajax({
        url : "<?= base_url('Superdokter/filter_profil_3') ?>",
        data : "id=" + id,
        success:function(data){
    ...
    function tgl(){
      ...
      $.ajax({
        url : "<?= base_url('Superdokter/filter_tanggal') ?>",
        data : "tgl=" + tgl,
        success:function(data){
          $('#txtfilter').html(data);
          // $('#txtfilter_2').html(data);
      ...
      $.ajax({
        url : "<?= base_url('Superdokter/filter_tanggal_2') ?>",
        data : "tgl=" + tgl,
        success:function(data){
          $('#txtfilter_2').html(data);
        }
      ...
      $.ajax({
        url : "<?= base_url('Superdokter/filter_tanggal_3') ?>",
        data : "tgl=" + tgl,
        success:function(data){
          $('#txtfilter_3').html(data);
        }
    ...
    function stok(value) {
      ...
      // '<button class="btn red col-sm-6" style="float: right; width: 100px" type="button" href="<?php echo base_url();?>Superdokter/home_keluarga/'+value+'">Pilih</button>'+
      '<a href="<?php echo base_url();?>Superdokter/home_keluarga/'+value+'" class="btn red">&nbsp;&nbsp; Lihat &nbsp;&nbsp;</a>' +
      '</div>';
