...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main" >						
			...
			<div class="panel panel-default">
				<div class="panel-body">
					...
					<div class="kotak">
						<div class="col-xs-3 nav-gr">
							<div class="row box">
								<div class="box-gr mt-4 stileone">
									<div class="row boxx tablink" data-toggle="tab" href="#pilih_jadwal">
										...
										<div class="box-gr-circle"><div class="box-gr-count">1</div>
									</div>
								</div>
							...
							<div class="box-gr stileone1">
								<div class="row boxx tablink" data-toggle="tab" href="#data_diri">
									...
									<div class="box-gr-circle"><div class="box-gr-count">2</div>
								</div>
							</div>
							<div class="box-gr-circle cir-col"></div>
						</div>
						<div class="box-gr stileone2">
							<div class="row boxx tablink" data-toggle="tab" href="#keluhan">
								...
								<div class="box-gr-circle"><div class="box-gr-count">3</div>
							</div>
						</div>
						<div class="box-gr-circle cir-col"></div>
					...
					<div class="box-gr stileone3">
						<div class="row boxx tablink" data-toggle="tab" href="#metode_pembayaran">
							...
							<div class="box-gr-circle"><div class="box-gr-count">4</div>
						</div>
					</div>
					<div class="box-gr-circle cir-col"></div>
				</div>
				<div class="box-gr stileone4">
					<div class="row boxx tablink">
						...
						<div class="box-gr-circle"><div class="box-gr-count">5</div>
					</div>
				</div>
				<div class="box-gr-circle cir-col"></div>
			</div>
	...
	<div class="tab-content col-md-8">
		<div id="pilih_jadwal"  class="tab-pane fade in active">
			<form action="<?php echo base_url('Booking/create_action2/');?>" method="post" enctype="multipart/form-data">
			...
			<div id="data_diri" class="tab-pane fade">
				...
				<div id="data_diri1" >
					<div class="col-md-12">
						<h5 class="mb-20 weight-500" style="font-weight: bold">Informasi Umum</h5><br></div>
						<?php foreach ($pasien->result() as $result) : ?>
							<div class="col-lg-2">	 
								...
								<div class="col-lg-4">	
									<div class="form-group">	
										<select class="form-control" name="tempat_lahir" id="tempat_lahir"  required>
											<option value="<?php echo $result->tempat_lahir; ?>" disabled selected style="display: none;"><?php echo $result->tempat_lahir; ?></option>
										...
										<div class="col-lg-4">	
											<div class="form-group">	
												<select class="form-control" name="jenis_kelamin" id="jenis_kelamin"  required>
													<option value="<?php echo $result->jenis_kelamin; ?>" disabled selected style="display: none;"><?php echo $result->jenis_kelamin; ?></option>
											...
											<div class="col-lg-4">	
												<div class="form-group">	
													<select class="form-control" name="status_nikah" id="status_nikah"  required>
														<option value="<?php echo $result->status_nikah; ?>" disabled selected style="display: none;"><?php echo $result->status_nikah; ?></option>
												...
												<div class="col-lg-4">	
													<div class="form-group">	
														<select class="form-control" name="pekerjaan" id="pekerjaan"  required>
															<option value="<?php echo $result->pekerjaan; ?>" disabled selected style="display: none;"><?php echo $result->pekerjaan; ?></option>
													...
													<div class="col-lg-4">	
														<div class="form-group">	
															<select class="form-control" name="pendidikan" id="pendidikan" >
																<option value="<?php echo $result->pendidikan; ?>" disabled selected style="display: none;" required><?php echo $result->pendidikan; ?></option>
														...
														<div class="col-lg-2">	
															<div class="form-group">	
																<select class="form-control" name="jenis_id" id="jenis_id" >
																	<option value="<?php echo $result->jenis_id; ?>" disabled selected style="display: none;" required><?php echo $result->jenis_id; ?></option>
														...
														<div id="data_diri2" hidden>
															<div class="col-md-12">
																<h5 class="mb-20 weight-500" style="font-weight: bold">Alamat dan kontak yang bisa dihubungi</h5><br></div>
																<div class="col-lg-2">	 
																	Nama Jalan
																</div>
																<div class="col-lg-10">	
																	...
																	<div class="col-lg-3">	
																		<div class="form-group">	
																			<select class="form-control" name="kota_kab" id="kota_kab" required>
																				<option value="<?php echo $result->kota_kab; ?>" disabled selected style="display: none;"><?php echo $result->kota_kab; ?></option>
																				<option value="Malang" id="Malang">Malang</option>
																				<option value="Surabaya" id="Surabaya">Surabaya</option>
																				<option value="Semarang" id="Semarang">Semarang</option>
																				<option value="Medan" id="Medan">Medan</option>
																		...
																		<div class="col-lg-3">	
																			<div class="form-group">	
																				<select class="form-control" name="provinsi" id="provinsi" required>
																					<option value="<?php echo $result->provinsi; ?>" disabled selected style="display: none;"><?php echo $result->provinsi; ?></option>
																			...
																			<div class="col-lg-2">	
																				...
																				<div class="col-lg-4">	
																					...
																					<div class="col-md-12">
																						<h5 class="mb-20 weight-500" style="font-weight: bold">Kondisi Kesehatan Umum</h5><br></div>
																						<div class="col-lg-2">	 
																							Golongan Darah
																						</div>
																						<div class="col-lg-2">	
																							...
																							<button onclick="next2()" type="button" class="btn salmon" style="float: right;  margin-top: 13%;">Selanjutnya</button></div>
																							<div id="data_diri3" hidden>
																								<div class="col-md-12">
																									
																									<h5 class="mb-20 weight-500" style="font-weight: bold">Informasi Orang terdekat</h5><br></div>
																									<div class="col-lg-2">	 
																										Nama Depan
																									</div>
																									<div class="col-lg-4">	
																														...
																														<div class="col-lg-4">	
																															<div class="form-group">	
																																<select class="form-control" name="hubungan_dekat" id="hubungan_dekat" required>
																																	...
																																	<option value="Teman" id="Teman">Teman</option>
																																</select>
																															</div></div>
																															<div class="col-lg-2">	 
																																Jenis ID
																															...
																															<div class="col-lg-2">	
																																...
																																<div class="col-md-12">
																																	<h5 class="mb-20 weight-500" style="font-weight: bold">Alamat dan kontak orang terdekat yang bisa dihubungi </h5><br></div>
																																	<div class="col-lg-2">	 
																																		Nama Jalan
																																	</div>
																																	<div class="col-lg-10">	
																																		...
																																		<div class="col-lg-3">	
																																			...
																																			<div class="col-lg-2">	
																																				...
																																				<div class="col-lg-4">	
																																					...
																																					<button onclick="next3()" type="button" class="btn salmon" style="float: right; margin-top: 1%;">Selanjutnya</button></div>
																																					<div id="data_diri4" hidden>
																																						<div class="col-md-12">
																																							<h5 class="mb-20 weight-500" style="font-weight: bold">Survey Pasien</h5><br></div>
																																							<div class="col-lg-6">	 
																																								Seberapa sering kamu mengunjungi dokter gigi?
																																							</div>
																																							<div class="col-lg-6">	<div class="form-group" required>	
																																					...
																																					<div id="keluhan" class="tab-pane fade">
																																						<div class="col-md-12">
																																							<h5 class="mb-20 weight-500" style="font-weight: bold">Keluhan yang dialami</h5><br></div>
																																							<div class="col-lg-4">	 
																																							...
																																							<div id="metode_pembayaran" class="tab-pane fade">
																																								<div class="col-md-12">
																																									<h5 class="mb-20 weight-500" style="font-weight: bold">Metode pembayaran</h5><br></div>
																																									<div class="col-lg-2">	 
																																										Jenis Pembayaran
																																									</div>
																																									<div class="col-lg-4">	
																																									...
																																									<div id="asuransiku" hidden>
																																										<div class="col-md-12">
																																											<h5 class="mb-20 weight-500" style="font-weight: bold">Detail Asuransi</h5><br></div>
																																											<div class="col-lg-2">	 
																																												Provider Asuransi
																																											</div>
																																											<div class="col-lg-4">	
																																									...
																																									<div id="konfirmasi_booking" class="tab-pane fade">
																																										...
																																										<div class="row col-lg-5 mt-f" >
																																											<a href="" class="btn btn-sm btn-success mt-9" data-formatter="lanjut" data-align="center">Kembali ke Beranda</a>
																																										</div>
																																									</div>
																																								</div>
																																							</div>
