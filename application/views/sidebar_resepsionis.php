...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar show-sidebar" style="background-color: #f2f2f2;">
	...
	<ul id="Show" class="nav menu sidelayout">
		<li <?php if (isset($_antrian)) 		  echo 'class="active"';?>><a href="<?php echo site_url('superdokter/home')?>"><i class="fa fa-th-large" aria-hidden="true"></i> &nbsp;  Antrian</a></li>
		<li <?php if (isset($_konfirmasi)) 		  echo 'class="active"';?>><a href="<?php echo site_url('superdokter/Konfirmasi_janji')?>"><i class="fa fa-calendar" aria-hidden="true"></i> &nbsp; Konfirmasi Janji</a></li>
		<li <?php if (isset($_registrasi)) 		  echo 'class="active"';?>><a href="<?php echo site_url('superdokter/registrasi_janji')?>"><i class="fa fa-check-circle-o" aria-hidden="true"></i> &nbsp;  Registrasi / Ubah Janji</a></li>
		<li <?php if (isset($_pembayaran)) 		  echo 'class="active"';?>><a href="<?php echo site_url('superdokter/pembayaran')?>"><i class="fa fa-credit-card" aria-hidden="true"></i> &nbsp;   Pembayaran</a></li>
		<li <?php if (isset($_laporan_transaksi)) echo 'class="active"';?>><a href="<?php echo site_url('superdokter/laporan_harian')?>"><i class="fa fa-line-chart" aria-hidden="true"></i> &nbsp;   Laporan Harian</a></li>
