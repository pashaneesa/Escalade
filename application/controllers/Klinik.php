...
class Klinik extends CI_Controller {
  ...
  function home_keluarga($id_user) {
    ...
    $data['_antrian'] = 1;
    $data['content'] = 'resepsionis/home_keluarga';
    $this->load->view('template/template', $data);
  }
  ...
  function tambah_pasien() {
    $data['_antrian'] = 1;
    $data['content'] = 'resepsionis/tambah_pasien';
    $this->load->view('template/template', $data);
  }
  ...
  public function tambah_pasien_k($id_user)
  {
    ...
    $data['user'] = $user;
    $data['_antrian'] = 1;
    $data['content'] = 'resepsionis/tambah_pasien_k';
    $this->load->view('template/template', $data);
  }
  ...
  public function add_pasien() {
   ...
   redirect(site_url('resepsionis/home'));
 }
 ...
 public function add_booking(){
  ...
  if ($id_pasien==""||$id_cabang==""||$id_dokter=="") {
    ...
    redirect(base_url('resepsionis/data_booking/'.$id_pasien.'/'.$id_booking));
  }
}
...
function data_booking($id_pasien,$id_booking) {
  ...
  $data['metodebayar'] = $bayar ; 
  $data['_antrian'] = 1;
  $data['content'] = 'resepsionis/booking';
  $this->load->view('template/template', $data);
}
...
function konfirmasi_janji() {
  ...
  $data['_konfirmasi'] = 1;
  $data['content'] = 'resepsionis/konfirmasi_janji';
  $this->load->view('template/template', $data);
}
...
public function konfirmasi(){
  ...
  redirect(site_url('resepsionis/konfirmasi_janji'));
}
...
public function registrasi_janji() {
  ...
  $data['dokter'] = $dokter;
  $data['_registrasi'] = 1;
  $data['content'] = 'resepsionis/registrasi_janji';
  $this->load->view('template/template', $data);
}
...
public function update_janji(){
  ...
  $this->Klinik_model->update_rekam_medis($this->input->post('id_booking'), $data_janji);
  $this->Klinik_model->add_antrian($data_antrian);
  redirect(site_url('resepsionis/registrasi_janji'));
}
...
public function pembayaran() {
  ...
  $data['bayar'] = $bayar;
  $data['_pembayaran'] = 1;
  $data['content'] = 'resepsionis/pembayaran';
  $this->load->view('template/template', $data);
}
...
public function metode_bayar($id_booking)
{
  ...
  $diskon = $this->Klinik_model->get_diskon();
  $data['diskon'] = $diskon;
  $data['_pembayaran'] = 1;
  $data['content'] = 'resepsionis/metode_pembayaran';
  $this->load->view('template/template', $data);
}
...
private function _uploadImage()
{
  ...
  $config['overwrite']            = true;
      ...
      public function update_bayar(){
        ...
        redirect(site_url('resepsionis/pembayaran'));
      }
      ...
      public function laporan_harian()
      {
        ...
        $data['content'] = 'resepsionis/laporan_harian';
        $this->load->view('template/template', $data);
      }
      ...
      public function laporan_harian_dokter()
      {
        ...
        $data['_laporan_transaksi'] = 1;
        $data['content'] = 'resepsionis/laporan_harian_d';
        $this->load->view('template/template', $data);
      }
      ...
      public function export_detail(){
       ...
       $this->load->view('resepsionis/vw_laporan_detail',$data);
     }
     ...
     public function export_harian(){
       ...
       $this->load->view('resepsionis/vw_laporan_pendapatan_harian',$data);
     }
     ...
     public function export_per_dokter(){
       ...
       $this->load->view('resepsionis/vw_laporan_perdokter',$data);
     }
